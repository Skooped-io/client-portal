...
// ===== Identity =====
// One identity for every activity row: the company.

export const SKOOPED_IDENTITY = {
  name: 'Skooped',
  color: '#D94A7A',
  bg: 'rgba(217,74,122,0.15)',
  initials: 'SK',
} as const
...
// ===== Demo data =====
// Sample rows used when an org has no real activity yet.
...
export const DEMO_BOT_ACTIVITIES: BotActivity[] = [
  {
    ...
    description: 'Scanned 48 target keywords. "garage door repair franklin tn" moved from position 7 to 4. Local pack visibility up 12%.',
  ...
  },
  {
    ...
    description: 'A customer left a 5-star review: "Fast, professional service. Had my door fixed same day. Highly recommend!" We responded within 2 hours.',
    metadata: { stars: 5, response_time_hours: 2 },
    read: true,
  ...
  },
  {
    ...
    description: 'Week of Mar 10 to 16: 428 sessions, 67 lead form views, 14 phone call clicks, 3 contact form submissions. Best day: Tuesday.',
  ...
  },
  {
    ...
    description: '"garage door spring replacement," "garage opener repair near me," and "commercial garage door service" all moved into positions 6 to 9 this week.',
  ...
  },
  {
    ...
    description: 'A customer left 4 stars: "Good service, tech was knowledgeable. Slight delay on arrival but fixed quickly." We responded with appreciation.',
    metadata: { stars: 4 },
    read: true,
  ...
  },
  {
    ...
    metadata: { posts: 5, platforms: 'instagram, facebook', period: 'Mar 17 to 30' },
    read: true,
